...
Monk Remix
Available for all Enhanced Edition games, or the original Windows versions of BG2/Tutu/BGT

This component changes Monks to bring them more in line with their 3rd Edition pen-and-paper counterparts. Their class description becomes as follows:
...
- May use 'Flurry of Blows' ability once per day. The monk gains 1 additional attack per round for the next turn, but also suffers -4 THAC0 penalty. This penalty is reduced to -3 at 5th level, -2 at 9th level, and -1 and 13th level.
...
- May use 'Quivering Palm' ability once per day at 15th level. The monk's next successful melee attack sets up vibrations in the target's body, causing it to save vs. death or die. NOTE: this special ability automatically modifies a Monk's normal attack, so no targeting needs to be done.
- May use 'Empty Body' ability once per day per level at 19th level. The monk assumes an ethereal state for 1 round, becoming invisible and immune to immune to all damage, but also unable to launch any attack.
...
This component will install the Hexblade fighter kit.
...
This component will install the Duelist fighter kit.
...
This component will install the Fist of Order fighter kit.
...
Install Blackguard Fighter Kit
...
Install Duskblade Fighter Kit

This component will install the Duskblade fighter kit.
